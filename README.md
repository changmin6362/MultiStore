...
- [ ] 환경 변수 관리 구조화
- [ ] Vercel 배포
- [ ] Domain Service, Application Service 구조로 리팩토링
- [ ] MSA 분리 후 AWS 배포
...
- [x] Form의 Validation 및 응답 에러 메시지 처리
- [x] httponly 쿠키를 사용한 토큰 관리
- [x] RBAC 기능을 사용한 Access Control 기능
- [x] 관리자 페이지 api 연결
- [ ] 메인 페이지 api 연결
- [ ] 마이 페이지 api 연결
- [ ] 주소 관리 페이지 api 연결
...
- [ ] 검색 페이지 api 연결
- [ ] 장바구니 페이지 api 연결
- [ ] 주문 페이지 api 연결 및 PG사 연동
- [ ] 스토어별 대시보드 기능 구현 (매출 요약, 주문 현황, 방문자 통계, 재고 현황)
- [ ] 스토리북에 페이지 추가

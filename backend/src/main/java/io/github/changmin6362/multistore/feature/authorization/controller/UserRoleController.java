...
public class UserRoleController {
    ...
    public ResponseEntity<ApiResponse> getUserRoles(@PathVariable BigInteger userId) {
    ...
    public ResponseEntity<ApiResponse> assignRoleToUser(@PathVariable BigInteger userId,
                                                        @RequestBody AssignRoleRequest body) {
        Integer roleId = body != null ? body.roleId() : null;
        if (roleId == null) {
    ...
    public ResponseEntity<ApiResponse> removeRoleFromUser(@PathVariable BigInteger userId,
    ...
    public ResponseEntity<ApiResponse> getUserPermissions(@PathVariable BigInteger userId) {
